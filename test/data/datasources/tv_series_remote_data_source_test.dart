...
void main() {
    ...
    test('should return list of Tv Series Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/on_the_air?$API_KEY')))
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv/tv_series_now_playing.json'), 200));
      // act
  ...
  group('get Popular Tv Series', () {
    final tTvSeriesList = TvSeriesResponse.fromJson(
            json.decode(readJson('dummy_data/tv/tv_series_popular.json')))
        .tvSeriesList;
  ...
  group('get tv series detail', () {
    ...
    test('should return tv series detail when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/tv/tv_series_detail.json'), 200));
      // act
  ...
  group('search tv series', () {
    final tSearchResult = TvSeriesResponse.fromJson(
            json.decode(readJson('dummy_data/tv/tv_series_search_breaking.json')))
        .tvSeriesList;
    ...
    test('should return list of tv series when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv/tv_series_search_breaking.json'), 200));
      // act
